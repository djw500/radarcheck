...
@patch("build_tiles.record_tile_hour")
@patch("build_tiles.record_tile_variable")
@patch("build_tiles.record_tile_run")
@patch("build_tiles.init_db")
...
def test_build_region_tiles_ecmwf(mock_save, mock_build, mock_download,
                                   mock_init_db, mock_record_run,
                                   mock_record_var, mock_record_hour):
    # Setup
